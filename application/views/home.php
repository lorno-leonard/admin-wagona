...
<head>
  ...
  <link rel="stylesheet" href="assets/src/css/bootstrap.css" type="text/css" />
  <link rel="stylesheet" href="assets/src/css/animate.css" type="text/css" />
  <link rel="stylesheet" href="assets/src/css/font-awesome.min.css" type="text/css" />
  <link rel="stylesheet" href="assets/src/css/font.css" type="text/css" />
  <link rel="stylesheet" href="assets/src/js/theme-plugins/calendar/bootstrap_calendar.css" type="text/css" />
  <link rel="stylesheet" href="assets/src/css/app.css" type="text/css" />
  <!--[if lt IE 9]>
    <script src="assets/src/js/theme-plugins/ie/html5shiv.js"></script>
    <script src="assets/src/js/theme-plugins/ie/respond.min.js"></script>
    <script src="assets/src/js/theme-plugins/ie/excanvas.js"></script>
  <![endif]-->
</head>
<body class="">
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="assets/src/images/logo.png" class="m-r-sm">Notebook</a>
          ...
          <section class="dropdown-menu aside-xl on animated fadeInLeft no-borders lt">
            <div class="wrapper lter m-t-n-xs">
              <a href="#" class="thumb pull-left m-r">
                <img src="assets/src/images/avatar.jpg" class="img-circle">
              </a>
              <div class="clear">
              ...
              <div class="list-group list-group-alt animated fadeInRight">
                <a href="#" class="media list-group-item">
                  <span class="pull-left thumb-sm">
                    <img src="assets/src/images/avatar.jpg" alt="John said" class="img-circle">
                  </span>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <span class="thumb-sm avatar pull-left">
              <img src="assets/src/images/avatar.jpg">
            </span>
                  ...
                  <article id="comment-id-2" class="comment-reply">
                    <article class="comment-item">
                      <a class="pull-left thumb-sm">
                        <img src="assets/src/images/avatar_default.jpg" class="img-circle">
                      </a>
                      <section class="comment-body m-b-lg">
                        <header>
  ...
  <script src="assets/src/js/theme-plugins/jquery.min.js"></script>
  <!-- Bootstrap -->
  <script src="assets/src/js/theme-plugins/bootstrap.js"></script>
  <!-- App -->
  <script src="assets/src/js/theme-plugins/app.js"></script> 
  <script src="assets/src/js/theme-plugins/slimscroll/jquery.slimscroll.min.js"></script>
  <script src="assets/src/js/theme-plugins/charts/easypiechart/jquery.easy-pie-chart.js"></script>
  <script src="assets/src/js/theme-plugins/charts/sparkline/jquery.sparkline.min.js"></script>
  <script src="assets/src/js/theme-plugins/charts/flot/jquery.flot.min.js"></script>
  <script src="assets/src/js/theme-plugins/charts/flot/jquery.flot.tooltip.min.js"></script>
  <script src="assets/src/js/theme-plugins/charts/flot/jquery.flot.resize.js"></script>
  <script src="assets/src/js/theme-plugins/charts/flot/jquery.flot.grow.js"></script>
  <script src="assets/src/js/theme-plugins/charts/flot/demo.js"></script>

  <script src="assets/src/js/theme-plugins/calendar/bootstrap_calendar.js"></script>
  <script src="assets/src/js/theme-plugins/calendar/demo.js"></script>

  <script src="assets/src/js/theme-plugins/sortable/jquery.sortable.js"></script>
  <script src="assets/src/js/theme-plugins/app.plugin.js"></script>
</body>
</html>